...
public class MtonTestContainer extends TestContainer {

    public MtonTestContainer() {
        super();
    ...
    public static class Common extends MtonTestContainer {

        public static final MtonTestContainer.Common INSTANCE = new MtonTestContainer.Common();
