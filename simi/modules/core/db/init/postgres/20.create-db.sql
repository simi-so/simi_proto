...
create unique index IDX_SIMI_TABLE_OF_CONTENTS_UK_IDENTIFIER on SIMI_TABLE_OF_CONTENTS (IDENTIFIER) where DELETE_TS is null ^
-- end SIMI_TABLE_OF_CONTENTS
-- begin SIMI_SINGLE_ACTOR_LIST_PROPERTIES
alter table SIMI_SINGLE_ACTOR_LIST_PROPERTIES add constraint FK_SIMI_SINGLE_ACTOR_LIST_PROPERTIES_ON_TABLE_OF_CONTENTS foreign key (TABLE_OF_CONTENTS_ID) references SIMI_TABLE_OF_CONTENTS(ID)^
...
create index IDX_SIMI_SINGLE_ACTOR_LIST_PROPERTIES_ON_TABLE_OF_CONTENTS on SIMI_SINGLE_ACTOR_LIST_PROPERTIES (TABLE_OF_CONTENTS_ID)^
