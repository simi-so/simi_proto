...
public class FirstTestContainer extends TestContainer {

    public FirstTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/first/app.properties",
    ...
    public static class Common extends FirstTestContainer {

        public static final FirstTestContainer.Common INSTANCE = new FirstTestContainer.Common();
